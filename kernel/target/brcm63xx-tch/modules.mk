...
ifdef CONFIG_PACKAGE_kmod-brcm-5.02L.03
	...
	#4.16L05 and 5.02L.02 -> remove check if those are no longer used
...
define KernelPackage/bcm63xx-tch-wireless-emf
  ...
  DEPENDS+=+(PACKAGE_kmod-brcm-5.02L.02||PACKAGE_kmod-brcm-5.02L.03):kmod-bcm63xx-tch-wireless-wlcsm
  DEPENDS+=(PACKAGE_kmod-brcm-5.02L.02||PACKAGE_kmod-brcm-5.02L.03):kmod-bcm63xx-tch-mcast
#For impl22 and higher
ifeq ($(shell [ "$(CONFIG_BCM_WLAN_IMPL)" ] && [ "$(CONFIG_BCM_WLAN_IMPL)" -ge 22 ]; echo $$?),0)
...
define KernelPackage/bcm63xx-tch-wireless-dhd
  ...
  DEPENDS+=+(PACKAGE_kmod-brcm-5.02L.02||PACKAGE_kmod-brcm-5.02L.03):kmod-bcm63xx-tch-wireless-wlcsm
  DEPENDS+=(PACKAGE_kmod-brcm-5.02L.02||PACKAGE_kmod-brcm-5.02L.03):kmod-bcm63xx-tch-mcast
  DEPENDS+=(PACKAGE_kmod-brcm-5.02L.02||PACKAGE_kmod-brcm-5.02L.03):kmod-bcm63xx-tch-wfd
  KCONFIG:=CONFIG_BCM_WLAN
#For impl22 and higher  
ifeq ($(shell [ "$(CONFIG_BCM_WLAN_IMPL)" ] && [ "$(CONFIG_BCM_WLAN_IMPL)" -ge 22 ]; echo $$?),0)
...
#For impl32 and higher  
ifeq ($(shell [ "$(CONFIG_BCM_WLAN_IMPL)" ] && [ "$(CONFIG_BCM_WLAN_IMPL)" -ge 32 ]; echo $$?),0)
...
define KernelPackage/brcm-5.02L.03
  ...
  TITLE:=Broadcom release 5.02L.03
  DEPENDS:=@TARGET_brcm63xx_tch
  KCONFIG:=CONFIG_BCM_WLAN_IMPL=32
