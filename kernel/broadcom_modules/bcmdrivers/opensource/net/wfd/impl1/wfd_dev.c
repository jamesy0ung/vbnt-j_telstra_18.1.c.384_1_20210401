...
#ifdef CONFIG_TCH_KF_WLAN_PERF_TX_WFD
...
#endif /* CONFIG_TCH_KF_WLAN_PERF_TX_WFD */
/* FRV: Direct release of buffers from wl to wfd */
...
/* FRV BEGIN: Use same preemption method as in other RT threads (wlx-thread, bcmswrx, skbFreeTask) */
                    ...
                    schedule();
#endif
/* FRV END: Use same preemption method as in other RT threads (wlx-thread, bcmswrx, skb_free_task) */
                }
