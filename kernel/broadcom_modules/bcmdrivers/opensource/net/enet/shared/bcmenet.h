...
typedef struct BcmEnet_devctrl {
    ...
    struct rtnl_link_stats64 lstats;    /* Last switch stats */ \
...
#if !defined(CONFIG_BCM96838) && !defined(CONFIG_BCM963138) && !defined(CONFIG_BCM963148) && !defined(CONFIG_BCM96848) && !defined(CONFIG_BCM96858) && !defined(CONFIG_BCM96836) && !defined(CONFIG_BCM94908)
