...
/* GPIO leds */
static struct gpio_led gpled_vbntz[] = {
	{
		.name = "power:red",
		.gpio = 0,
		.active_low = 1,
...
/* Shift register leds */
static struct shiftled_led led_inf_dsc_vbntz[] = {
};

LED_FAMILY_WITHOUT_SR(vbntz);
LED_BOARD(vbntz, vbntz, "VBNT-Z");
...
static struct board * boards[] = {&board_vantc, &board_vantd, &board_vante, &board_vantf, &board_vantg, &board_vant9, &board_vbntz, &board_vant5, &board_vbnta, &board_vant6,&board_vbntr, &board_vant7, &board_vant8, &board_vantr, &board_gbntg, &board_vant4, &board_vdnt3, &board_vdnt4, &board_vdntw, &board_vdnto, &board_vdnt6, &board_vdnt8, &board_gant1, &board_gant2,  &board_gant8, &board_vantt, &board_vdnty, &board_gantk, &board_vbntl, &board_vbntb, &board_vbntn, &board_vbntt,0};
