...
GPIO_BUTTON_BOARD(vant9, vbntz, "VBNT-Z");
...
static struct gpio_keys_button gpio_buttons_vbnt1[] = {
    {
        .desc		= "reset",
        .gpio		= 32,
        .active_low	= 1,
...
static struct gpio_keys_button gpio_buttons_vbntw[] = {
    {
        .desc		= "reset",
        .gpio		= 32,
        .active_low	= 1,
...
static struct gpio_keys_button gpio_buttons_vbnty[] = {
    {
        .desc		= "reset",
        .gpio		= 32,
        .active_low	= 1,
...
static struct gpio_keys_button gpio_buttons_vbnt7[] = {
    {
        .desc		= "reset",
        .gpio		= 32,
        .active_low	= 1,
...
GPIO_BUTTON_BOARD(vbntg, vbnt5, "VBNT-5");
...
GPIO_BUTTON_FAMILY(vbnt1);
GPIO_BUTTON_BOARD(vbnt1, vbnt1, "VBNT-1");
GPIO_BUTTON_BOARD(vbnt1, vbnt2, "VBNT-2");
GPIO_BUTTON_BOARD(vbnt1, vbnt8, "VBNT-8");

GPIO_BUTTON_FAMILY(vbnto);
GPIO_BUTTON_BOARD(vbnto, vbnto, "VBNT-O");
GPIO_BUTTON_BOARD(vbnto, vbnto_sfp, "VBNT-O_SFP");

GPIO_BUTTON_FAMILY(vbntw);
GPIO_BUTTON_BOARD(vbntw, vbntw, "VBNT-W");
GPIO_BUTTON_BOARD(vbntw, vbnt6, "VBNT-6");
GPIO_BUTTON_BOARD(vbntw, vcntc, "VCNT-C");

GPIO_BUTTON_FAMILY(vbnty);
GPIO_BUTTON_BOARD(vbnty, vbnty, "VBNT-Y");
GPIO_BUTTON_BOARD(vbnty, vcnta, "VCNT-A");

GPIO_BUTTON_FAMILY(vbnt7);
GPIO_BUTTON_BOARD(vbnt7, vbnt7, "VBNT-7");

static struct board * boards[] = {&board_vanth, &board_vantw, &board_vantv, &board_vbntf, &board_vbntk, &board_vbnts, &board_vbntk, &board_vbnts, &board_vbntk_sfp, &board_vbnts_sfp, &board_vbnth, &board_vanty, &board_vbntj, &board_gbnta, &board_vbntg, &board_vbntm, &board_vbnt5, &board_vbnt1, &board_vbnt2, &board_vbnt8, &board_vbnto,&board_vbnto_sfp, &board_vbntv, &board_vbntw, &board_vbnt6, &board_vbnty, &board_vcnta, &board_vbnt7, &board_vcntc, 0};
...
#elif defined(CONFIG_ARCH_ALPINE)

static struct gpio_keys_button gpio_buttons_gbntj[] = {
    {
        .desc           = "wifi",
        .type           = EV_KEY,
        .code           = BTN_1,
...
GPIO_BUTTON_FAMILY(gbntj);
GPIO_BUTTON_BOARD(gbntj, gbntj, "GBNT-J");

static struct board * boards[] = {&board_gbntj, 0};

#elif defined(CONFIG_ARCH_IPQ807x)

static struct gpio_keys_button gpio_buttons_gbnto[] = {
    {
        .desc		= "reset",
        .gpio		= 32,
        .active_low	= 1,
...
GPIO_BUTTON_FAMILY(gbnto);
GPIO_BUTTON_BOARD(gbnto, gbnto, "GBNT-O");

static struct board * boards[] = {&board_gbnto, 0};

#elif defined(CONFIG_BCM96858)

static struct gpio_keys_button gpio_buttons_gbntq[] = {
        {
                .desc		= "wps",
                .gpio		= 53,
                .active_low	= 1,
...
GPIO_BUTTON_FAMILY(gbntq);
GPIO_BUTTON_BOARD(gbntq, gbntq, "GBNT-Q");

static struct gpio_keys_button gpio_buttons_gbntw[] = {
        {
                .desc		= "reset",
                .gpio		= 54,
                .active_low	= 1,
...
GPIO_BUTTON_FAMILY(gbntw);
GPIO_BUTTON_BOARD(gbntw, gbntw, "GBNT-W");

static struct board * boards[] = {&board_gbntq, &board_gbntw, 0};
