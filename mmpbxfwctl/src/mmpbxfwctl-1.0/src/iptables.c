...
static void print_header(unsigned int format, const char *chain, struct xtc_handle *handle)
{
...
static int append_entry(const xt_chainlabel   chain,
                        struct ipt_entry      *fw,
...
static int replace_entry(const xt_chainlabel chain,
                         struct ipt_entry *fw,
                         unsigned int rulenum,
...
static int delete_entry(const xt_chainlabel         chain,
                        struct ipt_entry            *fw,
                        unsigned int                nsaddrs,
                        const struct in_addr        saddrs[],
                        const struct in_addr        smasks[],
...
static int list_entries(const xt_chainlabel chain, int rulenum, int verbose, int numeric,
...
static void print_iface(char letter, const char *iface, const unsigned char *mask,
                        int invert)
{
    unsigned int i;
