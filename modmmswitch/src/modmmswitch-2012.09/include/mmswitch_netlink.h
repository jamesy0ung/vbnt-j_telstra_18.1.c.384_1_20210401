...
enum {
    ...
    MMSWITCH_ATTR_MMCONNKRNL_RTCP_SUPPORT,            /**< Does the kernel DSP module support RTCP. */
    ...
    MMSWITCH_ATTR_KEEP_STATS,                         /**< Do we need to keep track of statistics ? (0== FALSE, 1== TRUE). */
    __MMSWITCH_ATTR_MAX,
};
...
enum {
    ...
    MMSWITCH_ATTR_MMCONNRTCP_SESSIONDURATION,
    ...
    MMSWITCH_ATTR_MMCONNRTCP_TXRTCPXRPACKETS,
    MMSWITCH_ATTR_MMCONNRTCP_RXRTCPXRPACKETS,
    /*AT&T extension*/
