...
########################################################################*/
/**
 * RTP header template, can be used for interpreting data.
 */
typedef struct {
#ifdef __BIG_ENDIAN
 ...
 */
typedef struct MmConnDspRtpStatsParm {
 ...
 * \param [out] stats An MmConnDspRtpStatsParm structure handle or NULL
...
/**
 * Trigger an event related to a connection handle.  The event will be sent to the user space
 * counterpart of mmConn.
 *
 * \since v1.0
 *
 * \pre \c mmConn must be a valid handle.
 *
 * \post The event has been sent to the user space counterpart of mmConn.
 *
