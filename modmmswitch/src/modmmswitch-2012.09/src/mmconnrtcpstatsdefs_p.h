 ...
 *
 *************************************************************************/
#ifndef  MMCONNBRCMSTATSDEFS_P_H
#define  MMCONNBRCMSTATSDEFS_P_H
...
typedef struct RTCPSTAT {
    ...
    RTPSRC          source;
    /**/
    uint64_t        rtcpXrPktsSent;       /* Number of RTCP-XR packets sent during session */
    uint64_t        rtcpPktsSent;         /* Number of RTCP packets sent during session */
    /*AT&T extension*/
...
#endif /* #ifdef _MMCONNRTCPSTATSDEFS_P_H_ */
