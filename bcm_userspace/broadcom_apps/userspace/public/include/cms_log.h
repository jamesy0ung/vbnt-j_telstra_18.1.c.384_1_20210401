...
#ifdef CMS_LOG2
#if defined(CONFIG_TECHNICOLOR_GPON_PATCH)
#define cmsLog_error(args...)  log_log_with_filename((CmsLogLevel)LOG_ERR, __FILE__, __FUNCTION__, __LINE__, args)
#define cmsLog_notice(args...) log_log_with_filename((CmsLogLevel)LOG_NOTICE, __FILE__, __FUNCTION__, __LINE__, args)
#else
...
#define cmsLog_error(args...)  log_log_with_filename((CmsLogLevel)LOG_ERR, __FILE__,  __FUNCTION__, __LINE__, args)
#define cmsLog_notice(args...) log_log_with_filename((CmsLogLevel)LOG_NOTICE, __FILE__, __FUNCTION__, __LINE__, args)
#define cmsLog_debug(args...)  log_log_with_filename((CmsLogLevel)LOG_DEBUG, __FILE__, __FUNCTION__, __LINE__, args)
#else
#define cmsLog_error(args...)  log_log((CmsLogLevel)LOG_ERR, __FUNCTION__, __LINE__, args)
#define cmsLog_notice(args...) log_log((CmsLogLevel)LOG_NOTICE, __FUNCTION__, __LINE__, args)
...
#if defined(CONFIG_TECHNICOLOR_GPON_PATCH)
void log_log_with_filename(CmsLogLevel level, const char *file, const char *func, UINT32 lineNum, const char *pFmt, ... );
#endif
