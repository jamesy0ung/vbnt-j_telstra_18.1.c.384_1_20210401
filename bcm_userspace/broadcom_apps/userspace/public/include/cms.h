...
typedef enum
{
   ...
   CMSRET_DU_UPDATE_VERSION_EXISTED= 9032,/**< Invalid Deployment Unit Update, version already exists
                                                    * (associated with ChangeDUState:update)
                                                    */
   CMSRET_IGMP_GROUP_IP_INVALID = 9100, /**<IGMP group IP is not in the multicast operation profile dynacl list. */
   CMSRET_IGMP_GROUP_BANDWIDTH_EXCEEDED = 9101, /**<IGMP group bandwidth exceed when comparing with the Max multicast bandwidth. */
   CMSRET_DISCARD_IGMP_PACKET = 9102, /**<IGMP packet should be discarded. */
