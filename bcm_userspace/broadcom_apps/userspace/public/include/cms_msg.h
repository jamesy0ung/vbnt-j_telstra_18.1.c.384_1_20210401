...
typedef enum 
{
   ...
   CMS_MSG_RESTART_VOICE                        = 0x10002005, /**< Voice re-start request. This is to restart the call manager when the IP address changes*/
   CMS_MSG_INIT_VOICE                           = 0x10002006, /**< Voice init request. */
   CMS_MSG_DEINIT_VOICE                         = 0x10002007, /**< Voice init request. */
   CMS_MSG_RESTART_VOICE_CALLMGR                = 0x10002008, /**< Voice call manager re-start request. */
   ...
   CMS_MSG_OMCI_GPONMD_BANK_ACTIVATE            = 0x10002255, /**< OMCID to GPONMD active instance*/
   CMS_MSG_OMCI_GPONMD_MULTICAST                = 0x10002256, /**< OMCID to GPONMD multicast enable/disable*/
   CMS_MSG_OMCI_GPONMD_TRSV_THRESHOLD_UPDATE    = 0x10002257, /**< OMCID to GPONMD trsv threshold update*/
   CMS_MSG_OMCI_GPONMD_CHANGE_LAYER3_INTF_STATE = 0x10002258, /**< OMCID to GPONMD, Change layer 3 interface state */
   CMS_MSG_OMCI_GPONMD_MIB_RESET                = 0x10002259, /**< OMCID to GPONMD, send mib reset message to gponmd*/
   CMS_MSG_OMCI_GPONMD_RF_STATE                 = 0x10002260, /**< OMCID to GPONMD, send rf state message to gponmd*/
   CMS_MSG_OMCI_GPONMD_MULTICAST_VLANF          = 0x10002261, /**< OMCID to GPONMD, send multicast vlanfilter message to gponmd*/
   CMS_MSG_OMCI_GPONMD_OLT_SWITCHOVER           = 0x10002262, /**< OMCID to GPONMD, send olt switchover message to gponmd*/
   CMS_MSG_OMCI_GET_MCAST_CTL_INFO              = 0x10002254, /**< request GPON OMCI multicast control info */
   CMS_MSG_OMCI_TRSV_THRSHLD_SET_REQUEST        = 0x10002263, /**< GPONMD to OMCID, send the threshold data to omcid */
   CMS_MSG_OMCI_MIBUPLOAD_SET_REQUEST           = 0x10002264, /**< CONSOLED to OMCID, control OMCI MIBUpload */
   CMS_MSG_OMCI_MEHIDE_SET_REQUEST              = 0x10002265, /**< CONSOLED to OMCID, hide one ME, to control OmciGetNext response */
   ...
   CMS_MSG_LXC_STATUS_INFO                      = 0x10002502, /**< LXC update container's status */
...
/** Data body for CMS_MSG_OMCI_GPONMD_TRSV_THRESHOLD_UPDATE message type.
 *
 */
#define OMCI_TRSV_THRESHOLD_UPDATE_RX_RSSI	0x1
#define OMCI_TRSV_THRESHOLD_UPDATE_TX_POWER	0x2
#define OMCI_TRSV_THRESHOLD_UPDATE_RF_RSSI	0x3
...
/** Data body for CMS_MSG_OMCI_GPONMD_CHANGE_LAYER3_INTF_STATE message type.
 *
 */
#define LAYER3_INTF_STATE_UP      1
#define LAYER3_INTF_STATE_DOWN    0
typedef struct
{
    UINT32  uniVlanId;
    UINT32  state;
} OmciLayer3IntfMsgBody;
