...
#include "../../../../cfe/cfe/board/bcm63xx_btrm/inc/bcm63xx_main.h"   
#else
#include "../../../../cfe/cfe/board/bcm63xx_btrm/inc/bcm63xx_main_impl3.h"
#endif
#endif
...
int emmcUpdateMdataSeqnum( char * mdata_ptr, int image_num, int seq_num )
{
    ...
    if (otp_is_boot_secure())
        strcpy(fname, EMMC_CFE_RAM_SECBT_NAME);
    ...
    else
    {
        if (otp_is_boot_mfg_secure())
            strcpy(fname, EMMC_CFE_RAM_SECBT_MFG_NAME);
    }
#endif
#endif
