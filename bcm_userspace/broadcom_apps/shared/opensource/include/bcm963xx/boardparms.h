...
/* In case of a single LED per RJ45, the LED Function 1 Ctrl Register value should be set.
   The wanted function is LNK/ACT (Link / Activity) for all speeds (ref datasheet of BCM53124S).
   So on the even numbered LED-Outputpins (LED[00, 02, 04, 06, 08]), the register should be set to 0x20,
   on odd numbered LED, the register should be set to 0x0820 */
#define BP_EXTSW_BCM53124S_BACKPANEL_LEDS_ON_EVEN_NUMBERED_PIN 0x0020
#define BP_EXTSW_BCM53124S_BACKPANEL_LEDS_ON_ODD_NUMBERED_PIN 0x0820
...
#define BP_NET_LED_SHIFT      0
#define BP_NET_LED_SPEED_MASK (0xffff << (BP_NET_LED_SHIFT))
#define BP_NET_LED_SPEED_10   (1 << (BP_NET_LED_SHIFT))
#define BP_NET_LED_SPEED_100  (1 << (BP_NET_LED_SHIFT + 1))
#define BP_NET_LED_SPEED_1G   (1 << (BP_NET_LED_SHIFT + 2))
#define BP_NET_LED_SPEED_2500 (1 << (BP_NET_LED_SHIFT + 3))
#define BP_NET_LED_SPEED_10G  (1 << (BP_NET_LED_SHIFT + 4))
...
#define BP_NET_LED_SPEED_ALL  (BP_NET_LED_SPEED_MASK)
#define BP_NET_LED_ACTIVITY_ALL  (BP_NET_LED_SPEED_MASK)
...
int BpGetVethPortmap_tch(int *num, char *cpVethPortmap);
