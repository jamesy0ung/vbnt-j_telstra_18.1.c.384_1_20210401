...
#define SLICSLAC_LIST_COMMON_NOFXO      &g_voiceBoard_NOSLIC,             \
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vanty =
{
    /* 2 FXS lines; 1 FXO lines */
    VOICECFG_TCH_VANTY_STR,   /*Daughter Card ID */
    {
      /* Device 0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbntj =
{
    /* 2 FXS lines; 1 FXO lines */
    VOICECFG_TCH_VBNTJ_STR,   /*Daughter Card ID */
    {
      /* Device 0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbnty =
{

    VOICECFG_TCH_VBNTY_STR,   /*Daughter Card ID */
    {
        /* voiceDevice0 parameters */
        {
            /* Device type */
        ...
        /* Device 1 parameters */
        {
            ...
            {
                /* Channel 0 on device */
                BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_NONE,  BP_VC_COMP_LINEAR, BP_VC_8KHZ, TS(6, 7) ),
                /* Channel 1 on device */
                BP_CHAN( BP_VC_INACTIVE, BP_VCTYPE_NONE, BP_VC_COMP_LINEAR, BP_VC_8KHZ ),
            }
        },
    ...
    /* SLIC Device Profile */
    BP_VD_LCQCUK_TCH_EXT_ATTN,

   /* General-purpose flags */
   ( BP_FLAG_DSP_PCMHAL_ENABLE )
};

VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vcnta =
{

    VOICECFG_TCH_VCNTA_STR,   /*Daughter Card ID */
    {
        /* voiceDevice0 parameters */
        {
            /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbntv =
{
    /* 2 FXS lines; 1 FXO lines */
    VOICECFG_TCH_VBNTV_STR,   /*Daughter Card ID */
    {
      /* Device 0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbnts =
{
    /* 2 FXS lines; 0 FXO lines */
    VOICECFG_TCH_VBNTS_STR,   /*Daughter Card ID */
    {
      /* Device 0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbnto =
{
    VOICECFG_TCH_VBNTO_STR,   /*Daughter Card ID */
    {
      /* voiceDevice0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbntw =
{
    VOICECFG_TCH_VBNTW_STR,   /*Daughter Card ID */
    {
      /* voiceDevice0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbnt6 =
{
    VOICECFG_TCH_VBNT6_STR,   /*Daughter Card ID */
    {
      /* voiceDevice0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vcntc =
   {
      VOICECFG_TCH_VCNTC_STR,   /*Daughter Card ID */
      {
         /* voiceDevice0 parameters */
         {
            /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbnt7 =
{
    /* 1 FXS line; 0 FXO lines */
    VOICECFG_TCH_VBNT7_STR,   /*Daughter Card ID */
    {
      /* voiceDevice0 parameters */
      {
          /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vantf =
{
    ...
    VOICECFG_TCH_VANTF_STR,   /*Daughter Card ID */
    {
        ...
        /* Voice Device 1 */
        {
            ...
            {
                BP_CHAN_PCM(BP_VC_ACTIVE, BP_VCTYPE_DAA, BP_VC_COMP_LINEAR, BP_VC_8KHZ, TS(4,5)),
                /* There is no second channel, mark it as inactive */
                BP_CHAN( BP_VC_INACTIVE, BP_VCTYPE_NONE, BP_VC_COMP_LINEAR, BP_VC_8KHZ ),
            }
        },
        /* Always end device list with this macro. */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vbntz =
{
    /* 1 FXS Lines */
    VOICECFG_TCH_VBNTZ_STR,   /*Daughter Card ID */
    {
        /* voiceDevice0 parameters */
        {
            /* Device type */
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_tch_vant5 =
{
    ...
    VOICECFG_TCH_VANT5_STR,   /*Daughter Card ID */
    {
        /* Device 0 parameters */
        {
            ...
            {
                /* Channel 0 on device */
                BP_CHAN_PCM(BP_VC_INACTIVE, BP_VCTYPE_SLIC, BP_VC_COMP_LINEAR, BP_VC_8KHZ, TS(0, 1)),
                /* Channel 1 on device */
                BP_CHAN_PCM(BP_VC_ACTIVE, BP_VCTYPE_SLIC, BP_VC_COMP_LINEAR, BP_VC_8KHZ, TS(2, 3)),
            }
        },
...
static VOICE_DAUGHTER_BOARD_PARMS * g_vbntz_dCardList[] = {
   &g_voiceBoard_tch_vbntz, 0
};
...
static bp_elem_t g_voice_tch_vbntz[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-Z"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,            .u.us = BP_GPIO_20_AL},
   {bp_daughterCardList,        .u.ptr = g_vbntz_dCardList},
   {bp_last}
};
...
static VOICE_DAUGHTER_BOARD_PARMS * g_vanth_dCardList[] = {
   &g_voiceBoard_tch_vanth,
   0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vantw_dCardList[] = {
   &g_voiceBoard_tch_vantw,
   0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vantv_dCardList[] = {
   &g_voiceBoard_tch_vantv,
   0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vanty_dCardList[] = {
   &g_voiceBoard_tch_vanty,
   0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbntj_dCardList[] = {
   &g_voiceBoard_tch_vbntj, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbntv_dCardList[] = {
   &g_voiceBoard_tch_vbntv, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbnty_dCardList[] = {
   &g_voiceBoard_tch_vbnty, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vcnta_dCardList[] = {
   &g_voiceBoard_tch_vcnta, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbntf_dCardList[] = {
   &g_voiceBoard_tch_vbntf,
   0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbnth_dCardList[] = {
   &g_voiceBoard_tch_vbnth,
   0
};
...
static VOICE_DAUGHTER_BOARD_PARMS * g_vbnts_dCardList[] = {
   &g_voiceBoard_tch_vbnts, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbnto_dCardList[] = {
   &g_voiceBoard_tch_vbnto, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbntw_dCardList[] = {
   &g_voiceBoard_tch_vbntw, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbnt6_dCardList[] = {
   &g_voiceBoard_tch_vbnt6, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vcntc_dCardList[] = {
   &g_voiceBoard_tch_vcntc, 0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_vbnt7_dCardList[] = {
   &g_voiceBoard_tch_vbnt7, 0
};
...
static bp_elem_t g_voice_tch_vanty[] = {
   ...
   {bp_usGpioFxsFxoRst2,        .u.us = BP_GPIO_7_AL},
   {bp_usGpioFxsFxoRst3,        .u.us = BP_GPIO_27_AL},
   {bp_usGpioDectRst,           .u.us = BP_GPIO_5_AL},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_4_AL},   //Lab1 R018
   {bp_usGpioVoipRelayCtrl2,    .u.us = BP_GPIO_14_AL},  //Lab1 R018
   {bp_iDectCfg,                .u.ptr = g_iDectStdCfg},
   {bp_daughterCardList,        .u.ptr = g_vanty_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbntj[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-J"},
   {bp_usGpioFxsFxoRst3,            .u.us = BP_GPIO_71_AL},
   {bp_daughterCardList,        .u.ptr = g_vbntj_dCardList},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_tch_vanty},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbntv[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-V"},
   {bp_daughterCardList,        .u.ptr = g_vbntv_dCardList},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_tch_vbntj},
   {bp_last}
};
...
static bp_elem_t g_voice_tch_vbnts[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-S"},
   {bp_daughterCardList,        .u.ptr = g_vbnts_dCardList},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_tch_vbntf},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbnts_sfp[] = {
...
static bp_elem_t g_voice_tch_vbnto[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-O"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_0},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_3_AL},
   {bp_usGpioDectRst,           .u.us = BP_NOT_DEFINED},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_NOT_DEFINED},
   {bp_daughterCardList,        .u.ptr = g_vbnto_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbnto_sfp[] = {
 {bp_cpBoardId, .u.cp = "VBNT-O_SFP"},
 {bp_daughterCardList, .u.ptr = g_vbnto_dCardList},
 {bp_elemTemplate, .u.bp_elemp = g_voice_tch_vbnto},
 {bp_last}
};

static bp_elem_t g_voice_tch_vbntw[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-W"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_7_AL},
   {bp_daughterCardList,        .u.ptr = g_vbntw_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbnt6[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-6"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_7_AL},
   {bp_daughterCardList,        .u.ptr = g_vbnt6_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vcntc[] = {
   {bp_cpBoardId,               .u.cp = "VCNT-C"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_7_AL},
   {bp_daughterCardList,        .u.ptr = g_vcntc_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbnt7[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-7"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_0},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_36_AL},
   {bp_daughterCardList,        .u.ptr = g_vbnt7_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vbnty[] = {
   {bp_cpBoardId,               .u.cp = "VBNT-Y"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_36_AL},
   {bp_usGpioDectRst,           .u.us = BP_GPIO_118_AL},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_4_AL},
   {bp_iDectCfg,                .u.ptr = g_iDectStdCfg},
   {bp_daughterCardList,        .u.ptr = g_vbnty_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_tch_vcnta[] = {
   ...
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_4_AL},
   {bp_iDectCfg,                .u.ptr = g_iDectStdCfg},
   {bp_daughterCardList,        .u.ptr = g_vcnta_dCardList},
   {bp_last}
};
...
static bp_elem_t * g_VoiceBoardParms[]=
{
   ...
   g_voice_tch_vbnts_sfp,
   g_voice_tch_vbnto,
   g_voice_tch_vbnto_sfp,
   g_voice_tch_vbntw,
   g_voice_tch_vbnt6,
   g_voice_tch_vbnty,
   g_voice_tch_vcnta,
...
#if !defined(_BCM963268_) && !defined(CONFIG_BCM963268) && !defined(_BCM96838_) && !defined(CONFIG_BCM96838) && !defined(_BCM963138_) && !defined(CONFIG_BCM963138) && !defined(_BCM963381_) && !defined(CONFIG_BCM963381) && !defined(_BCM963148_) && !defined(CONFIG_BCM963148) && !defined(CONFIG_BCM96848) && !defined(_BCM94908_) && !defined(CONFIG_BCM94908) && !defined(_BCM96858_) && !defined(CONFIG_BCM96858) && !defined(_BCM96836_) && !defined(CONFIG_BCM96836)
...
#ifdef CONFIG_MMPBX_API_PATCH
            case BP_VCTYPE_NONE:
               if( vdi->deviceType == BP_VD_QUECTEL_25) {
                   vp.numNosigLines++;
                   break;
               }
#endif
...
#ifdef CONFIG_MMPBX_API_PATCH
   if(vp.numFxsLines + vp.numFxoLines + vp.numDectLines + vp.numNosigLines> 8)
#else
