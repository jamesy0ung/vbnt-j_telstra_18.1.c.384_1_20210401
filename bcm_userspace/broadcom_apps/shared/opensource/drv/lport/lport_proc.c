...
static int lport_proc_cmd_stats(int argc, char *argv[])
{
    ...
    pr_info("+----------------+---------++----------------+---------+\n");
    pr_info("| Rx Packet OK   |%9lu|| Tx Packet OK   |%9lu|\n", rx_stats.GRXPOK, tx_stats.GTXPOK);
    pr_info("| Rx 64 Byte     |0x%7lx|| Tx 64 Byte     |0x%7lx|\n", rx_stats.GRX64, tx_stats.GTX64);
    pr_info("| Rx 65 to 127   |%9lu|| Tx 65 to 127   |%9lu|\n", rx_stats.GRX127, tx_stats.GTX127);
    pr_info("| Rx 128 to 255  |%9lu|| Tx 128 to 255  |%9lu|\n", rx_stats.GRX255, tx_stats.GTX255);
    pr_info("| Rx 256 to 511  |%9lu|| Tx 256 to 511  |%9lu|\n", rx_stats.GRX511, tx_stats.GTX511);
    pr_info("| Rx 512 to 1023 |%9lu|| Tx 512 to 1023 |%9lu|\n", rx_stats.GRX1023, tx_stats.GTX1023);
    pr_info("| Rx 1024 to 1518|%9lu|| Tx 1024 to 1518|%9lu|\n", rx_stats.GRX1518, tx_stats.GTX1518);
    pr_info("| Rx 1519 to 2047|%9lu|| Tx 1519 to 2047|%9lu|\n", rx_stats.GRX2047, tx_stats.GTX2047);
    pr_info("| Rx frame       |%9lu|| Tx frame       |%9lu|\n", rx_stats.GRXPKT, tx_stats.GTXPKT);
    pr_info("| Rx Bytes       |0x%7lx|| Tx Bytes       |0x%7lx|\n", rx_stats.GRXBYT, tx_stats.GTXBYT);
    pr_info("| Rx Unicast     |%9lu|| Tx Unicast     |%9lu|\n", rx_stats.GRXUCA, tx_stats.GTXUCA);
    pr_info("| Rx Multicast   |%9lu|| Tx Multicast   |%9lu|\n", rx_stats.GRXMCA, tx_stats.GTXUCA);
    pr_info("| Rx Broadcast   |%9lu|| Tx Broadcast   |%9lu|\n", rx_stats.GRXBCA, tx_stats.GTXBCA);
    pr_info("| Rx FCS Error   |%9lu|| Tx FCS Error   |%9lu|\n", rx_stats.GRXFCS, tx_stats.GTXFCS);
    pr_info("| Rx Control     |%9lu|| Tx Control     |%9lu|\n", rx_stats.GRXCF, tx_stats.GTXCF);
    pr_info("| Rx PAUSE       |%9lu|| Tx PAUSE       |%9lu|\n", rx_stats.GRXPF, tx_stats.GTXCF);
    pr_info("| Rx PFC         |%9lu|| Tx PFC         |%9lu|\n", rx_stats.GRXPP, tx_stats.GTXPFC);
    pr_info("| Rx Unsup Op    |%9lu|| Tx Oversized   |%9lu|\n", rx_stats.GRXUO, tx_stats.GTXOVR);
    pr_info("| Rx Unsup DA    |%9lu||                |         |\n", rx_stats.GRXUDA);
    pr_info("| Rx Wrong SA    |%9lu||                |         |\n", rx_stats.GRXWSA);
    pr_info("| Rx Align Error |%9lu||                |         |\n", rx_stats.GRXALN);
    pr_info("| Rx Length OOR  |%9lu||                |         |\n", rx_stats.GRXFLR);
    pr_info("| Rx Code Error  |%9lu||                |         |\n", rx_stats.GRXFRERR);
    pr_info("| Rx False Carri |%9lu||                |         |\n", rx_stats.GRXFCR);
    pr_info("| Rx Oversized   |%9lu||                |         |\n", rx_stats.GRXOVR);
    pr_info("| Rx Jabber      |%9lu||                |         |\n", rx_stats.GRXJBR);
    pr_info("| Rx MTU ERR     |%9lu||                |         |\n", rx_stats.GRXMTUE);
    pr_info("| Rx Truncated   |%9lu||                |         |\n", rx_stats.GRXTRFU);
    pr_info("| Rx SCH CRC     |%9lu||                |         |\n", rx_stats.GRXSCHCRC);
    pr_info("| Rx RUNT        |%9lu||                |         |\n", rx_stats.GRXRPKT);
    pr_info("| Rx Undersize   |%9lu||                |         |\n", rx_stats.GRXUND);
    pr_info("| Rx Fragment    |%9lu||                |         |\n", rx_stats.GRXFRG);
    pr_info("+----------------+---------++----------------+---------+\n");
