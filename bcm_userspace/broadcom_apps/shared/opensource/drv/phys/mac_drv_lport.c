...
static int port_lport_cfg_get(mac_dev_t *mac_dev, mac_cfg_t *mac_cfg)
{
    ...
    mac_cfg->pause_rx = flow_ctrl.rx_pause_en ? 1 : 0;
    mac_cfg->pause_tx = flow_ctrl.tx_pause_en ? 1 : 0;
...
static int port_lport_cfg_set(mac_dev_t *mac_dev, mac_cfg_t *mac_cfg)
{
    ...
    flow_ctrl.rx_pause_en = mac_cfg->pause_rx ? 1 : 0;
    flow_ctrl.tx_pause_en = mac_cfg->pause_tx ? 1 : 0;
