...
int spi_flash_init(flash_device_info_t **flash_info)
{
...
#if defined(_BCM94908_) || defined(CONFIG_BCM94908) || defined(_BCM96858_) || defined(CONFIG_BCM96858) || defined(_BCM6836_) || defined(CONFIG_BCM96836) || defined(_BCM963158_) || defined(CONFIG_BCM963158)
       spi_flash_busnum = HS_SPI_BUS_NUM;
       spi_flash_clock = 50000000;
#endif
    ...
    /* Added by TCH; 512 seems to be the maximum supported */
    if (spi_max_op_len > 512) spi_max_op_len = 512;
    ...
    *flash_info = &flash_spi_dev;
    ...
    switch( device_id >> 8 ) {
        ...
        case WBPART:
        case AMICPART:
            /* for the part smaller than 64K, use 4K sectors, as this is what
             * is already in use. Smooth upgrading is not possible.
             */
            sectorsize = SECTOR_SIZE_4K;
            switch ((unsigned short)(device_id & 0x00ff)) {
                case ID_M25P16:
                ...
                case ID_M25P64:
                    numsector = 2048;
                    break;
                /* for the parts of 16Mb and larger, use 64K sectors */
                case ID_M25P128:
                    sectorsize = SECTOR_SIZE_64K;
                    numsector = 256;
                    break;
    ...
    printk("SPI part=0x%02x id=0x%02x numsector=%d, sectorsize=%d, addr32=%d\n", (device_id>>8), (device_id & 0x00ff), numsector, sectorsize, addr32);
