...
#if defined(_BCM963148_) || defined(_BCM96848_) || defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM96836_) || defined(_BCM963158_)
    cfg = NAND->NandConfigExt;
#if defined(_BCM96858_) && (CONFIG_BCM_CHIP_REV != 0x6858B0)
    // in A0 it is not possible to drive GPIO23 low, used for NAND page size
    // redefined page size straps: 0b010 - 2K, and 0b011 - 4K
