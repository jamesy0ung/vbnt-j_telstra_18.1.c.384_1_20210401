...
**                                                                          **
** Copyright (c) 2012-2017 Technicolor                                      **
** All Rights Reserved                                                      **
**                                          
...
#if ( defined(BUILDTYPE_cfe_bootloader) || defined(BUILDTYPE_uboot_bootloader) )  && defined(CONFIG_RIPDRV_CRYPTO_SUPPORT)
...
int rip2_get_size(void)
{
    return rip2_flash_get_size();
}
