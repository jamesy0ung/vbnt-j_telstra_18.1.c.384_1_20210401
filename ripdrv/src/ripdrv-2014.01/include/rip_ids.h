...
#define RIP_ID_RANDOM_KEY_C                  0x012A /* Random number 3 (2048 bytes); different for each gateway */
#define RIP_ID_RANDOM_KEY_D                  0x012B /* Random number 4 (2048 bytes); different for each board mnemonic */
#define RIP_ID_CWPSL                         0x012C /* Customizable WPS pin list */
#define RIP_ID_CWEPL                         0x012D /* Customizable WEP Key list */
#define RIP_ID_CWPAL                         0x012E /* Customizable WPA passphrase list */
#define RIP_ID_CGAKL                         0x012F /* Customizable Generic Access Key List */
...
#define RIP_CP_SFP      0x2000 // SFP HW
