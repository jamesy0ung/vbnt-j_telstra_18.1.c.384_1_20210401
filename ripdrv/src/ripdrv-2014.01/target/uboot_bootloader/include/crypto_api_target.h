/* The buffer size of CAPI_MAX_ENC_CTX_SIZE is calculated as follows,
*   Environment : uboot_bootloader(64 bits) Algorithm : tomcrypt
*   struct symmetric_key in tomcrypt returns 968 bytes for RIJNDAEL AES.
*   The additional values are from symmetric_CBC and KeyInstance */
#define CAPI_MAX_ENC_CTX_SIZE   1116
