...
static void setup(void)
{
    ...
    memset(rip, 0xFF, rip2_size);
    rip2_flash_init(rip, rip2_size);

    rv = rip2_init(rip, 0, rip2_size);
...
START_TEST(test_rip2_init__init)
    uint8_t *hdr = (uint8_t*)(rip+rip2_get_size()-sizeof(uint32_t));
